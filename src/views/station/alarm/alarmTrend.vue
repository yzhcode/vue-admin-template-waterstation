<template>
    <div>
        <div class="query-block clearfix">
            <!-- 自定义水站组件 -->
            <!-- <QueryWaterSelect :waterid.sync="waterId" :waterlineid.sync="activeID"/> -->
            <!-- 自定义流水线组件 -->
            <!-- <assemblyLine class="fl m-r-20" :waterid="waterId" v-model="activeID"/> -->
        ...
        <!-- 饼图 -->
        <div class="query-sector-block clearfix">
...
<script>
    ...
    export default {
        data(){
            return{
				waterId         : this.$route.query.sid,//水站ID
                activeID        : "1",//选中水线ID
                types           : {
        ...
        methods:{
            ...
            queryWaterAlarm() {
                try{
                    ...
                    console.log("station alarmLog wateraffairs_id: "+this.waterId);
                    ...
                    this.$fetch({
                        ...
                        method: "get",
                        data: {
                            wateraffairs_id     : this.waterId, //水站ID，all:表示查询全部
                        ...
                        console.log("station alarmLog alarmInfo: "+jsonData);
                    ...
                    this.$loading.hide();
                    this.clearData();
                    console.log("station alarmLog alarmInfo: "+e);
                };
            },
            initPercentData(){
                this.clearData();
