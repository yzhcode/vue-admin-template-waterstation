        ...
        <ul class="query-line clearfix">
            <li v-for="item in alarm_trend">
                <div class="line-block">
                    ...
                    <div class="line-item">
                        <echart :options="global_.initLine(item.trend_data.time, item.trend_data.alarm_count, item.trend_data.alarm_treated_count)" :auto-resize="true" autoresize/>
                    </div>
                </div>
            </li>
        </ul>
        ...
        methods:{
            queryWaterAlarm() {
                try{
                    ...
                    this.$fetch({
                        url: "/Web/Report/alarmdata_bymonth?action=get",
                        method: "get",
                        data: {
                            wateraffairs_id: this.waterId, //查询站点ID，查询全部水站时，填all
                            select_month   : this.waterTime.join("-"), //开始日期，2020-04
                    ...
                    console.log("station alarmAlarmMonth queryWaterAlarm: "+e);
                };
            },
            alarmInfo(id, name) {
                try{
                    ...
                    let last = new Date(this.waterOldTime[0], parseInt(this.waterOldTime[1]),0).getDate();
                    ...
                    this.$fetch({
                        ...
                        data: {
                            wateraffairs_id: this.waterId, //查询站点ID，查询全部水站时，填all
                            start_date: this.waterOldTime.join("-")+"-01", //开始日期，2020-04-15
                            end_date: this.waterOldTime.join("-")+"-"+last, //结束日期，2020-04-15
                    ...
                    console.log("station alarmAlarmMonth alarmInfo: "+e);
                };
            },
        }
    }
